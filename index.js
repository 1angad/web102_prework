...
const totalCont = GAMES_JSON.reduce( (acc, total) => {
...
const totalAmount = GAMES_JSON.reduce( (acc, total) => {
...
const displayStr = `A total of $${totalAmount.toLocaleString('en-US')} has been raised for ${GAMES_JSON.length.toLocaleString('en-US')} games. Currently ${totalUnfunded.length} ${totalUnfunded === 1 ? " game remains" : " games remain"} unfunded. We need your help to fund these amazing games!`;
